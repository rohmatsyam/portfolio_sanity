...
const ContactMe = ({ pageInfo }: Props) => {
  ...
  return (
    <div className="relative flex items-center h-screen mx-auto max-w-screen">
      <div className="grid items-center justify-center w-full grid-cols-1 gap-4 text-center">
